...
(function (exports,im_lib_logger,main_core_events,ui_vue,ui_vue_vuex,im_lib_utils,main_core,im_const) {
	'use strict';
...
}((this.BX.Messenger.Model = this.BX.Messenger.Model || {}),BX.Messenger.Lib,BX.Event,BX,BX,BX.Messenger.Lib,BX,BX.Messenger.Const));
